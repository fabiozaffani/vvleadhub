...
- [`_index.md`](_index.md) (este) · [`_lexico.md`](_lexico.md) (termos canônicos) · [`_decisoes.md`](_decisoes.md) (ledger ADR D-1..D-21).
...
- Decisões fechadas (D-1..D-21) não se rediscutem — implementam-se; dúvida real → fundador.
