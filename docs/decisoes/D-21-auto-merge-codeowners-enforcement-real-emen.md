...
**Status:** fechada (emendada pela D-27) · **Data:** jun/2026 · **Tags:** gov, stack, produto
...
| ID | O que mudou |
|---|---|
| D-27 | Removeu `.cursor/rules` dos caminhos sensíveis porque o wrapper Cursor deixou de existir. |
