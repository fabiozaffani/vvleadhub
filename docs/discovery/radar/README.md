...
- **Coleta (D-24, emenda à D-19):** público **ou não** — **cliente oculto/mystery shopping no escopo** (preço real, script de venda, processo, pontos fracos do atendimento). Cerca mínima: meios **legítimos** (sem meio ilícito/quebra de NDA); **LGPD sobre PII de indivíduos** (rostos/nomes de vendedores, depoimentos de casais) — o alvo é a inteligência **de negócio**; **nunca** reusar criativo alheio nos nossos ads.
