...
**O que são:** consolidados **derivados** da coleta — produtos da análise, **não** atributos primários do Espaço-Concorrente (o robô *coleta* identidade/anúncios/reviews; a análise *produz* SWOT). SWOT = **Forças, Fraquezas, Oportunidades, Ameaças**. Carregam data de validade. A Reputação é o agregado derivado das Observações de review.
