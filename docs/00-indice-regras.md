...
| D-7 | **Greenfield:** o implementado em `artifacts/valeverde` é protótipo/implementação de referência, não base de migração. D-1 reconfirmada; Fase 0 = build; `CLAUDE.md` é a fonte única de instruções do agente | **fechada** |
