...
4. **Form de captura** → *Bloco Form de Lead* (âncora `#contato`). Eyebrow "AGENDE SUA VISITA" + título ("Venha conhecer seu futuro altar") + intro · campos do protótipo: **Nome · E-mail · Telefone/WhatsApp · Tipo de evento · Data prevista · Nº de convidados (aprox.) · Mensagem** · CTA "SOLICITAR ORÇAMENTO E VISITA". **Opt-in mínimo** (gancho LGPD — [`../decisoes.md`](../decisoes.md)). Submete ao **contrato de lead** ([`../specs/landing-pages/contrato-lead.md`](../specs/landing-pages/contrato-lead.md)) → api-server → Kommo.
