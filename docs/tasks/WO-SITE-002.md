...
- Structured data **por tipo**: `EventVenue`+`LocalBusiness` por espaço, `Article`/`BlogPosting`, `BreadcrumbList`, `FAQPage`, `VideoObject` (skill `seo-schema-org`).
...
## Refs
[`specs/landing-pages/seo-canonico.md`](../specs/landing-pages/seo-canonico.md), [`specs/blog/seo-on-page.md`](../specs/blog/seo-on-page.md), [`specs/engenharia/acessibilidade.md`](../specs/engenharia/acessibilidade.md), skills `seo-schema-org`/`a11y-axe`.
